  ...
  <div id="volunteer_index">
    ...
    <transition name="fade">
      <div v-show="!isLoading" class="volunteer_index1">
          ...
          <div class="swiper-container swiper-container22" ref="pr">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="(item,index) in bannerData">
                <img :src="item.img_url" :class="'top-swiper-shop'+index" alt="" @click="_appjs.syJsbLaunchWebview(item.touch_url)">
              </div>
            </div>
        ...
        <div class="two-list">
          <div class="div-one" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_apply')">
            <p class="p-one">组织入驻</p>
            <p class="p-two">志愿组织 {{numberData.volunteer_org}} 个</p>
          </div>
          <div class="div-two" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=become_volunteer')">
        ...
        <div class="wrapper-content">
          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st02')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org1.png'" alt="">
            <p>扶贫助困</p>
          </div>
          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st01')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org2.png'" alt="">
            <p>敬老助老</p>
          </div>

          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st04')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org3.png'" alt="">
            <p>关爱儿童</p>
          </div>

          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st18')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org4.png'" alt="">
            <p>社区便民</p>
          </div>

          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st15')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org5.png'" alt="">
            <p>教育科普</p>
          </div>

          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st16')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org6.png'" alt="">
            <p>绿色环保</p>
          </div>

          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st17')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org7.png'" alt="">
            <p>文化活动</p>
          </div>

          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st12')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org8.png'" alt="">
            <p>语言服务</p>
          </div>
          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st09')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org9.png'" alt="">
            <p>赛事服务</p>
          </div>
          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st10')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org10.png'" alt="">
            <p>应急救援</p>
          </div>
          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_list&service_type=st19')">
            <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/org11.png'" alt="">
            <p>国际志愿</p>
          </div>
          <div class="wrapper-item" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_organization')">
        ...
        <div class='wrapper-list'>
          <div class="wrapper-top">
            <span class="span-one"></span><span class="span-two">最新招募</span><span class="span-three" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_recruit')">查看更多 <span class="sworr"> ></span></span>
          </div>
          <div class="content-div">
            <div v-for="item in listsNew" class="list-wrapper" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=recruit_detail&recruit_id='+item.recruit_id)">
              <div class="title-wrapper">
                <div class="title-div has-width" >{{item.recruit_name}}</div>
              </div>
              <div style="overflow: hidden">
                <span class="address">{{(item.city+item.area)||"线上"}}</span><span class='time'>{{item.add_time}}</span>
              </div>
        ...
        <div class="wrapper-list" style="padding:0">
          <div class="wrapper-top" style="border-bottom: none;padding:0 .3rem;">
            <span class="span-one"></span><span class="span-two">友情合作</span><span class="span-three" @click="_appjs.syJsbLaunchWebview(siteInfo.host+'/mobile/index.php?act=volunteer_router&op=vol_friendteam')">查看更多 <span class="sworr"> ></span></span>
          </div>
          <!--友情合作-->
                  ...
                  <div class="tabItem clearfix">
                    <div class="">
                      <div>
                        ...
                        <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/volunteer/friend2'+index+'.png'" alt="" class="friend_img">
