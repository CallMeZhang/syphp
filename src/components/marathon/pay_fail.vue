<template>
  <div style="height: 100%;">
    ...
    <div class="reg_result">
      <div class="header">
        <div class="img">
          <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/marathon/icon-fail.png'" alt="报名成功">
        </div>
        <p>支付失败</p>
      </div>
      <div class="regInfo">
        <div class="regCon">
          <div class="info">
            ...
            <div class="infoBto">
              <p>您的报名申请因支付失败未能成功提交，您可以选择“重新支付”完成报名申请。</p>
            </div>
          </div>
        </div>
      </div>
      <div class="footer">
        <div class="btn"
             @click="_appjs.syJsbLaunchWebview(siteInfo.host+ '/bocm/index.php?act=marathon_enroll&op=pay&marathon_id=' + marathon_id)">
          重新支付
        </div>
      </div>
    </div>
