      ...
      <div v-show="!isLoading">
        <div class="contianer">
          <div class="wrapper">
            ...
            <!--推荐联盟-->
            <div class="unit">
              <div class="unitHead">- 推荐联盟 -</div>
              <div class="unitCon">
                <ul class="cle">
                  <li v-for="item in recommend" @click="item.union_free == '1' ? selectUnion(item.union_channel) : showTip()">
                    <div class="itemCon">
            ...
            <div class="unit">
              ...
              <div class="unitCon">
                <ul class="cle">
                  <li v-for="(item, index) in gover" @click="item.union_free == '1' ? selectUnion(item.union_channel) : showTip()" v-if="index < 3">
                    <div class="itemCon">
                      <div class="try" v-if="item.union_operation == '1'">
                        <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/index/test_run_v1.png'">
                      </div>
                  ...
                  <li v-if="gover.length>3" @click="$router.push('selectUnionB/gove')">
                    <div class="more">
                      更多
                      <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/index/ap41.png'">
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div class="company">
              ...
              <div class="unitCon unitCon2">
                <ul class="cle">
                  <li v-for="(item, index) in comp" @click="item.union_free == '1' ? selectUnion(item.union_channel) : showTip()" v-if="index < 3">
                    <div class="itemCon">
                      <div class="try" v-if="item.union_operation == '1'">
                        <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/index/test_run_v1.png'">
                      </div>
                  ...
                  <li v-if="comp.length>3" @click="$router.push('selectUnionB/comp')">
                    <div class="more">
                      更多
                      <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/index/ap41.png'">
                    </div>
...
<script>
  import {getUnion,saveUnion} from '@/requests/index'
