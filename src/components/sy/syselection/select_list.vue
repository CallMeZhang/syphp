  ...
  <div class="selectList">
    ...
    <transition name="fade">
      <div class="wrapper clearfix">
              ...
              <div class="navGoodsList">
                <ul class="clearfix">
                  <li class="fl" @click="getInfo(i.gc_id,i.gc_name)" v-for="(i,index) in item[gc_deep3_list]">
                    <div class="tabImg">
                      <div :style="{backgroundImage:'url('+i.gc_image+')'}"
                           style="width: 100%;height: 100%;background-size: contain;background-repeat: no-repeat;background-position: center;"></div>
                    </div>
                    <p>{{i.gc_name}}</p>
                  </li>
                </ul>
        ...
        <!--引导弹窗-->
        <div class="selectTip" v-show="showTip=false">
          <div class="selectTipContent">
            <div class="tipClose" @click="showTip = false">
              <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/sywall/close_x2.png'" alt="">
            </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="tipContent">
                    ...
                    <div class="tipList">
                      <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/syselection/icon1.png'" alt="step1">
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  ...
                  <div class="tipContent">
                    ...
                    <div class="tipList">
                      <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/syselection/icon2.png'" alt="step2">
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  ...
                  <div class="tipContent">
                    ...
                    <div class="tipList" style="height: 4.5rem;margin-top: 0.5rem;">
                      <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/syselection/icon3.png'" alt="step3">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="tipAgree clearfix" @click="getAgree">
              <div class="tipDg">
                <img :src="siteInfo.cdn_host+'/bocm/platformjs/static/image/syselection/icon-dg.png'" v-show="showDg">
              </div>
              <div style="margin-top: 0.08rem;">已知悉，不再提示</div>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  import local from '@/modules/_ls/index.js'
  export default{
    data(){
      return {
        isLoading: true,
...
//        if (this.showDg == true) {
//          local.setLsItem('showTips', 1)
//        } else {
//          local.removeLsItem('showTips')
//        }
//      }
    }
  }
...
<style>
  ...
  .syBullet.swiper-pagination-bullet-active{
    opacity: 1;
    background: #007aff;
  }
</style>
