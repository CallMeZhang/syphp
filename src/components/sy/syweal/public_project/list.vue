        ...
        <transition name="fade">
            <div class="list">
                <div class="wrapper">
                    <div class="nav">
                        <ul class="clearfix">
                            <li class="fl" @click="sladeTab('c')">
                                <div :class="type=='public_project' ? 'sel' : ''">公益众筹</div>
                            </li>
                            <li class="fl" @click="sladeTab('b')">
                                <div :class="type=='charitable_project' ? 'sel' : ''">慈善项目</div>
                            </li>
                            <li class="fl" @click="sladeTab('a')">
                                <div :class="type=='private_project' ? 'sel' : ''">个人求助</div>
                            </li>
                        </ul>
                    </div>
                    <!--公益求助-->
                    <div class="gyqz" v-show="!isLoading">
                                ...
                                <ul>
                                    <li class="clearfix" v-for="item in list" @click="_appjs.syJsbLaunchWebview(item.detial_url)">
                                        ...
                                        <div class="info fr">
                                            ...
                                            <p>截止：{{item.project_time_formatted}}</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            initData () {
                this.$http.get(this.siteInfo.host+'/api/index.php?act=publicproject&op=public_project_list&project_type='+this.type).then(res=>{
            ...
            sladeTab (tab) {
                ...
                switch (tab) {
                    case 'a':
                        this.type = 'private_project'
                        this.initData();break;
                    case 'b':
                        this.type = 'charitable_project'
                        this.initData();break;
                    case 'c':
                        this.type = 'public_project'
                        this.initData();break;
                    default:
                        this.type = 'private_project'
                        this.initData();break;
            ...
            loadBottom () {
                ...
                this.$http.get(this.siteInfo.host+'/api/index.php?act=publicproject&op=public_project_list&project_type='+this.type+'&cur_page='+this.current_page).then(res=>{
                    this.current_page++
