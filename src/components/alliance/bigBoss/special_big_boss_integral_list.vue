...
<script>
  ...
  export default{
    ...
    methods: {
      getData(){
        this.rankType = this.$route.query.rank_type || '';
        let url = this.siteInfo.host + '/api/index.php?act=union&op=rank_customized_list&rank_type='+this.rankType+'&curpage='+this.curPage;
