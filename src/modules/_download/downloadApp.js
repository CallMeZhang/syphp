...
var AppLink = /** @class */ (function() {
   ...
   */
  AppLink.prototype.tryCallApp = function(config) {
    var browser = Browser.getBrowser()
    ...
    // alert(ua)
    if(browser.isIOS){
      aLink.href = config.schemaIos
    }else if(browser.isAndroid){
      aLink.href = config.schemaAndroid
    }
